...
pprint.pprint(base_model.layers)

# Freeze all the layers in the original model (fine-tune only the added Dense layers)
for layer in model.layers[:5]:  # You need to figure out how many layers were in the base model to freeze
...
#Scalling down image by factor of 20
nb_train_samples = nb_train_samples/20
nb_validation_samples = nb_validation_samples/20
